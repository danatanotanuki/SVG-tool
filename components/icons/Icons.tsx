...
export const PolygonIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2l10 7.5-3.8 12.5H5.8L2 9.5z"></path>
    </svg>
);
...
export const PenToolIcon: React.FC<IconProps> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M18 13l-1.5-7.5L2 4l3 3L18 13z"></path>
        <path d="M12.5 2.5l-2.5 2.5"></path>
    </svg>
);
...
export const DeselectIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
       <path d="M9 3H5a2 2 0 0 0-2 2v4m3-6V3m0 6V5m0 0h4m3 0h4a2 2 0 0 1 2 2v4m0-3v1m0 3v4a2 2 0 0 1-2 2h-4m3 0h-1m-3 0H5a2 2 0 0 1-2-2v-4m3 0v1m0 3v1"/>
    </svg>
);
